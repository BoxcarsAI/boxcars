    ...
    def key_lookup(key, kwargs)
      val = if kwargs.key?(key) && !kwargs[key].nil?
              ...
              env_keys.each do |env_key|
                candidate = ENV.fetch(env_key, nil)
...
require_relative "boxcars/conduct_result"
require_relative "boxcars/openai_client"
require_relative "boxcars/engine"
require_relative "boxcars/boxcar"
require_relative "boxcars/mcp"
require_relative "boxcars/train"
require_relative "boxcars/agent_runner"
require_relative "boxcars/agent_event"
