...
module Boxcars
  ...
  class XMLZeroShot < XMLTrain
    ...
    CTEMPLATE = [
      syst("<training>Answer the following questions as best you can. You have access to the following actions:\n",
           ...
           "  %<boxcar_names>s\n",
           "  <action_input>an input question to the action</action_input>\n",
