...
RSpec.configure do |c|
  ...
  c.before do |example|
    ...
    openai_client_backend = ENV.fetch("OPENAI_CLIENT_BACKEND", "official_openai")
    ...
    allow(ENV).to receive(:fetch).with("OPENAI_CLIENT_BACKEND", "official_openai").and_return(openai_client_backend)
